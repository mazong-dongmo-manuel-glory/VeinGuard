...
PALM_ROI_WIDTH_RATIO = float(os.getenv("VG_PALM_ROI_WIDTH_RATIO", "2.2"))
PALM_ROI_HEIGHT_RATIO = float(os.getenv("VG_PALM_ROI_HEIGHT_RATIO", "2.6"))
...
ENROLLMENT_MIN_PALM_ACTIVE_BLOCKS = int(os.getenv("VG_ENROLLMENT_MIN_PALM_ACTIVE_BLOCKS", "70"))
ENROLLMENT_MIN_PALM_LINE_STRENGTH = float(os.getenv("VG_ENROLLMENT_MIN_PALM_LINE_STRENGTH", "0.055"))
ENROLLMENT_MIN_PALM_ORIENTATION_CONFIDENCE = float(os.getenv("VG_ENROLLMENT_MIN_PALM_ORIENTATION_CONFIDENCE", "0.05"))
