...
ENROLLMENT_MAX_ATTEMPTS = int(os.getenv("VG_ENROLLMENT_MAX_ATTEMPTS", "10"))
TELEMETRY_INTERVAL_SECONDS = float(os.getenv("VG_TELEMETRY_INTERVAL_SECONDS", "1.0"))
NOIR_CLAHE_CLIP_LIMIT = float(os.getenv("VG_NOIR_CLAHE_CLIP_LIMIT", "2.4"))
NOIR_CLAHE_GRID_SIZE = int(os.getenv("VG_NOIR_CLAHE_GRID_SIZE", "8"))
NOIR_BLACKHAT_SMALL = int(os.getenv("VG_NOIR_BLACKHAT_SMALL", "9"))
NOIR_BLACKHAT_LARGE = int(os.getenv("VG_NOIR_BLACKHAT_LARGE", "17"))
NOIR_ADAPTIVE_BLOCK_SIZE = int(os.getenv("VG_NOIR_ADAPTIVE_BLOCK_SIZE", "21"))
NOIR_ADAPTIVE_C = int(os.getenv("VG_NOIR_ADAPTIVE_C", "6"))
ORB_FEATURE_COUNT = int(os.getenv("VG_ORB_FEATURE_COUNT", "192"))
ORB_DESCRIPTOR_LIMIT = int(os.getenv("VG_ORB_DESCRIPTOR_LIMIT", "64"))
