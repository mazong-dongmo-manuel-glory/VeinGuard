...
ENROLLMENT_SAMPLE_COUNT = int(os.getenv("VG_ENROLLMENT_SAMPLE_COUNT", "8"))
ENROLLMENT_MAX_ATTEMPTS = int(os.getenv("VG_ENROLLMENT_MAX_ATTEMPTS", "12"))
IDENTIFICATION_SAMPLE_COUNT = int(os.getenv("VG_IDENTIFICATION_SAMPLE_COUNT", "1"))
...
PALM_CODE_ORIENTATIONS = int(os.getenv("VG_PALM_CODE_ORIENTATIONS", "6"))
PALM_CODE_SIZE = int(os.getenv("VG_PALM_CODE_SIZE", "160"))
PALM_CODE_BLOCK_SIZE = int(os.getenv("VG_PALM_CODE_BLOCK_SIZE", "4"))
PALM_CODE_RING_COUNT = int(os.getenv("VG_PALM_CODE_RING_COUNT", "6"))
PALM_CODE_RING_OVERLAP = float(os.getenv("VG_PALM_CODE_RING_OVERLAP", "0.25"))
PALM_ROI_WIDTH_RATIO = float(os.getenv("VG_PALM_ROI_WIDTH_RATIO", "1.9"))
PALM_ROI_HEIGHT_RATIO = float(os.getenv("VG_PALM_ROI_HEIGHT_RATIO", "2.2"))
PALM_GABOR_KERNEL_SIZE = int(os.getenv("VG_PALM_GABOR_KERNEL_SIZE", "17"))
PALM_GABOR_SIGMA = float(os.getenv("VG_PALM_GABOR_SIGMA", "4.5"))
PALM_GABOR_LAMBDA = float(os.getenv("VG_PALM_GABOR_LAMBDA", "8.5"))
PALM_GABOR_GAMMA = float(os.getenv("VG_PALM_GABOR_GAMMA", "0.45"))
PALMCODE_MATCH_THRESHOLD = float(os.getenv("VG_PALMCODE_MATCH_THRESHOLD", "0.45"))
...
MIN_PALM_ACTIVE_BLOCKS = int(os.getenv("VG_MIN_PALM_ACTIVE_BLOCKS", "90"))
MIN_PALM_LINE_STRENGTH = float(os.getenv("VG_MIN_PALM_LINE_STRENGTH", "0.075"))
MIN_PALM_ORIENTATION_CONFIDENCE = float(os.getenv("VG_MIN_PALM_ORIENTATION_CONFIDENCE", "0.07"))
MIN_SHARPNESS = float(os.getenv("VG_MIN_SHARPNESS", "28.0"))
MIN_CAPTURE_QUALITY = float(os.getenv("VG_MIN_CAPTURE_QUALITY", "0.32"))
ENROLLMENT_MIN_MASK_FILL_RATIO = float(os.getenv("VG_ENROLLMENT_MIN_MASK_FILL_RATIO", "0.04"))
...
ENROLLMENT_MIN_PALM_ACTIVE_BLOCKS = int(os.getenv("VG_ENROLLMENT_MIN_PALM_ACTIVE_BLOCKS", "40"))
ENROLLMENT_MIN_PALM_LINE_STRENGTH = float(os.getenv("VG_ENROLLMENT_MIN_PALM_LINE_STRENGTH", "0.03"))
ENROLLMENT_MIN_PALM_ORIENTATION_CONFIDENCE = float(os.getenv("VG_ENROLLMENT_MIN_PALM_ORIENTATION_CONFIDENCE", "0.025"))
ENROLLMENT_MIN_SHARPNESS = float(os.getenv("VG_ENROLLMENT_MIN_SHARPNESS", "18.0"))
ENROLLMENT_MIN_CAPTURE_QUALITY = float(os.getenv("VG_ENROLLMENT_MIN_CAPTURE_QUALITY", "0.15"))
...
FIREBASE_TELEMETRY_SYNC_INTERVAL_SECONDS = float(
    os.getenv("VG_FIREBASE_TELEMETRY_SYNC_INTERVAL_SECONDS", "60")
)
FIREBASE_QUOTA_COOLDOWN_SECONDS = float(os.getenv("VG_FIREBASE_QUOTA_COOLDOWN_SECONDS", "300"))
